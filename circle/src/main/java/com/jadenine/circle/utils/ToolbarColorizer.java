...
public class ToolbarColorizer {
     ...
     */
    public static void colorizeToolbar(Toolbar toolbarView, int toolbarIconsColor, Activity
            activity) {
    ...
    PorterDuffColorFilter colorFilter) {
        ...
        viewTreeObserver.addOnGlobalLayoutListener(new ViewTreeObserver.OnGlobalLayoutListener() {
            ...
            public void onGlobalLayout() {
                ...
                decorView.findViewsWithText(outViews, overflowDescription, View
    ...
    private static void removeOnGlobalLayoutListener(View v, ViewTreeObserver
